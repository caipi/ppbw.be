...
'L_HOMEPAGE'					=> 'Главная',
'L_UNCLASSIFIED'				=> 'Без рубрики',
'L_INFO_PHP_VERSION'			=> 'PHP версия',
'L_INFO_MAGIC_QUOTES'			=> 'State of "magic quotes"',
'L_INFO_CHARSET'				=> 'кодировка',

# index.php
'L_ERR_THEME_NOTFOUND'			=> 'PluXml тема не найдена',
'L_ERR_FILE_NOTFOUND'			=> 'PluXml файл не найден',
...
'L_TENTH'						=> 'десятая',
'L_NTH'							=> 'и',
'L_CAPCHA_QUESTION'				=> 'Напечатать какая <span class="capcha-letter">%s</span> буква в этом тексте <span class="capcha-word">%s</span>?',

# class.plx.utils.php
'L_WRITE_ACCESS'				=> '%s имеет доступ на запись',
'L_WRITE_NOT_ACCESS'			=> '%s не имеет доступ на запись',
...
'L_MAIL_NOT_AVAILABLE'			=> 'Функция отправки почты пока нет',

# class.plx.motor.php
'L_FILE_VERSION_REQUIRED'		=> 'File "%sversion" is required by PluXml',
'L_ARTICLE_NO_TAG'				=> 'Для этого тэга нет статьи!',
...
'L_ARTFEED_RSS_CATEGORY'		=> 'Rss категорий',
'L_ARTFEED_RSS'					=> 'Rss статей',
'L_NO_COMMENT'					=> 'нет комментариев',
'L_COMMENT'						=> 'комментарий',
'L_COMMENTS'					=> 'комментария',
'L_COMFEED_RSS_ARTICLE'			=> 'Rss комментарев в статьях',
'L_COMFEED_RSS'					=> 'Rss комментарий',
...
# class.plx.feed.php
'L_FEED_NO_PRIVATE_URL'			=> 'закрытые URL не был инициализирован в настройках администрации!',
'L_FEED_комментарии'			=> 'Комментарии',
'L_FEED_ONLINE_комментарии'		=> 'Online комментарии',
'L_FEED_OFFLINE_комментарии'	=> 'Offline комментарии',
